...
graph TB
    ...
    subgraph "Server Environment"
        ...
        Framework[Web Framework<br/>Express/Hono/Custom]
    ...
    subgraph "Request Flow"
        direction TB
        A[1. DOM Event] --> B[2. Process Triggers]
        B --> C[3. Build Request]
        C --> D[4. Send via WebSocket]
        D --> E[5. Route to Handler]
        E --> F[6. Process & Respond]
        F --> G[7. Update DOM]
        F --> H[8. Broadcast OOB]
    end
    
    style WSXClient fill:#e1f5fe
    style WSXServer fill:#f3e5f5
